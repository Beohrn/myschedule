 ...
 */
class TeachersAdapter(val context: Context, val list: List<Teacher>): RecyclerView.Adapter<TeachersAdapter.ViewHolder>() {

  override fun onBindViewHolder(holder: ViewHolder?, position: Int) = (holder?.itemView as TeacherView).setData(list[position])
